              ...
              <div className="grid items-stretch gap-5 sm:grid-cols-2 lg:grid-cols-3">
                ...
                {filteredNews.map(
                  (item) => (
                    ...
                    <article
                      key={item.id}
                      className="group flex h-full flex-col overflow-hidden rounded-3xl border border-slate-200/80 bg-white shadow-md shadow-slate-200/40 transition-all duration-300 hover:-translate-y-1.5 hover:border-amber-200/60 hover:shadow-xl hover:shadow-amber-500/10"
                    >
                      ...
                      >
                        ...
                        {item.image ? (
                          ...
                          <div className="relative flex h-52 items-center justify-center overflow-hidden bg-gradient-to-br from-slate-950 via-slate-900 to-slate-800">
                            ...
                            <div className="relative flex h-20 w-20 items-center justify-center rounded-2xl border border-white/10 bg-white/10 text-5xl backdrop-blur-sm">
                              📰
                            </div>
                      ...
                      <div className="flex flex-1 flex-col p-6">
                        ...
                        <div className="flex items-center justify-between gap-3">
                          ...
                          <span className="max-w-[55%] truncate rounded-full bg-amber-50 px-3 py-1.5 text-xs font-bold text-amber-700">
                            {item.category ||
                              "اخبار"}
                          </span>

                          <span className="max-w-[45%] truncate text-xs font-bold text-slate-400">
                            {item.source ||
                              "منبع خبر"}
                          </span>
                        ...
                        >
                          ...
                          <h2 className="mt-5 line-clamp-2 min-h-[4rem] text-xl font-black leading-8 text-slate-950 transition group-hover:text-amber-600">
                            {item.title}
                          </h2>
                        ...
                        <p className="mt-4 line-clamp-3 min-h-[5.25rem] text-sm leading-7 text-slate-600">
                          {item.summary ||
                            item.content ||
                            "برای مشاهده جزئیات خبر وارد صفحه خبر شوید."}
                        </p>
                        ...
                        <div className="mt-auto flex items-center justify-between gap-3 border-t border-slate-100 pt-5">
                          ...
                          <Link
                            ...
                            className="inline-flex shrink-0 items-center gap-1 rounded-xl bg-slate-950 px-4 py-2.5 text-sm font-bold text-white transition hover:bg-amber-500"
                          >
                            ادامه خبر
